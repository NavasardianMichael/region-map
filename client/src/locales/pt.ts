...
const pt: CommonNs = {
  ...
  badges: {
    ...
    rows: {
      ...
      aiParser: 'Analisador e gerador de dados com IA (até {{count}} pedidos/dia)',
    },
    items: {
      observer: {
      ...
      chronographer: {
        name: 'Cronógrafo',
        description:
          'Tudo o que o Explorador oferece, mais uma página pública e incorporação iframe para os seus projetos, e um limite de IA mais alto (até 10 pedidos por dia).',
  ...
  visualizer: {
    ...
    embed: {
      ...
      copyEmbed: 'Código de incorporação',
    ...
    aiParserModal: {
      title: 'Agente de IA',
      limitedRequestsNote:
        'Os pedidos à IA estão limitados a {{max}} por dia. Restam-lhe {{count}} hoje.',
      aiAccuracyNote:
        'Os resultados gerados por IA podem não ser sempre precisos. Reveja-os antes de guardar.',
      placeholder:
        'Cole dados não tratados e a IA irá normalizá-los para o formato esperado (id, label, value, opcionalmente time)…',
      ...
      switchToAi: 'Mudar para vista de IA',
      tableEmpty: 'Ainda sem linhas. Adicione uma manualmente ou execute a IA.',
      tableAddRow: 'Adicionar linha',
      columnId: 'ID',
      columnLabel: 'Rótulo',
      columnValue: 'Valor',
      columnTime: 'Tempo',
      tabParser: 'Analisador',
      tabGenerator: 'Gerador',
      generatorPlaceholder:
        'Descreva o conjunto de dados a gerar (ex.: «População dos países da UE em 2023»)…',
      generatorSubmit: 'Gerar com IA',
      generatorParsing: 'Gerando…',
    ...
    legendConfig: {
      ...
      normalizeRanges: 'Normalizar intervalos',
      normalizeRangesAria: 'Distribuir intervalos uniformemente entre o mínimo e máximo atuais',
      normalizeRangesNoData: 'Sem dados numéricos para normalizar',
