...
const en: CommonNs = {
  ...
  nav: {
    ...
    languageSwitchingOverlay: 'Switching language',
    openMenu: 'Open menu',
    mainMenu: 'Menu',
  ...
  badges: {
    ...
    badgeUpgraded: "You're now on the {{badge}} badge.",
    paymentVerifying: 'Payment in process. Updating your badge…',
    paymentCancelledTitle: 'Payment cancelled',
    paymentCancelledDesc: 'You cancelled the payment. No charges were made.',
    paymentSuccessTitle: 'Payment successful',
    continueToProjects: 'Continue to My Projects',
    rows: {
  ...
  visualizer: {
    ...
    mapHeaderLockTooltip: 'Lock project',
    mapHeaderUnlockTooltip: 'Unlock project',
    mapHeaderLockedSaveTooltip: 'This project is locked. Unlock it to save changes.',
    mapAriaMapOf: 'Map of {{region}}',
    mapAriaNoCountrySelected: 'No country selected',
    tabData: 'Data',
    tabMap: 'Map',
    tabStyles: 'Styles',
    ...
    randomStylesPack: 'Apply Random Palette',
    randomPaletteLoadFailed: 'Could not load random palettes. Try again.',
    ...
    importData: {
      ...
      manualTooltip: 'Edit data in table view',
      manualTooltipNoCountry: 'Select a country first',
      manualAria: 'Edit data in table view',
      ...
      aiParserChronographerTooltip: 'AI Agent is available on the {{badgeName}} badge only.',
      ...
      format: {
        ...
        table: 'Table (manual)',
        tabDelimited: 'Tab delimited text (manual)',
        aiParser: 'AI Agent',
      },
    },
    importFormatTooltip: {
    ...
    exportModal: {
      ...
      exportPdfBuilding: 'Building PDF…',
      pdfPageFormatLabel: 'Page format:',
      pdfFormatA4: 'A4',
      pdfFormatA3: 'A3',
    ...
    tabDelimitedModal: {
      ...
      placeholder: 'Edit tab-separated rows (id, label, value — one per line)',
      pasteFormatTooltip:
    ...
    aiParserModal: {
      ...
      switchToAi: 'Switch to AI view',
      tableEmpty: 'No rows yet. Add a row manually or run the AI.',
      tableAddRow: 'Add row',
      columnId: 'ID',
      columnLabel: 'Label',
      columnValue: 'Value',
      ...
      generatorPlaceholder:
        'Describe the dataset to generate (e.g. "Population of EU countries in 2023")…',
      generatorSubmit: 'Generate with AI',
    ...
    legendConfig: {
      ...
      normalizeRanges: 'Normalize ranges',
      normalizeRangesAria: 'Distribute ranges evenly between current data min and max',
      normalizeRangesNoData: 'No numeric data to normalize',
      addRange: 'Add range',
    ...
    mapStyles: {
      ...
      tooltipPanDown: 'Pan down the map',
      tooltipPanLeft: 'Pan left the map',
      tooltipPanRight: 'Pan right the map',
  ...
  projects: {
    ...
    unlock: 'Unlock',
    lockedTag: 'Locked',
    lockedRenameTooltip: 'This project is locked. Unlock it to rename.',
    lockedDeleteTooltip: 'This project is locked. Unlock it to delete.',
    bulkSelectLockedTooltip: "Locked projects can't be selected for deletion.",
  },
  common: {
    loading: 'Loading...',
    save: 'Save',
  ...
  messages: {
    ...
    lockProjectContent: 'Lock "{{name}}"? Locking protects a project you consider finished.',
    lockProjectInfoTitle: "While locked, this project can't be changed",
    lockProjectInfoContent:
      'Saving, renaming, embed setting changes, and deletion are all blocked. You can still open the project, adjust it on screen, and export images — nothing is saved until you unlock it. Any public embed keeps working normally.',
    lockProjectOk: 'Lock project',
    unlockProjectTitle: 'Unlock project',
    unlockProjectContent: 'Unlock "{{name}}"? Changes and deletion will be possible again.',
    unlockProjectWarningTitle: 'Protection will be removed',
    unlockProjectWarningContent:
      'This project will no longer be protected from accidental changes or deletion.',
    unlockProjectOk: 'Unlock project',
    projectLocked: 'Project locked',
    projectUnlocked: 'Project unlocked',
    projectLockFailed: 'Failed to change the lock state. Please try again.',
    projectLockedError: 'This project is locked. Unlock it to make changes.',
    projectsBulkDeleted: '{{count}} projects deleted',
    projectsBulkDeletePartial: '{{count}} projects deleted. Locked projects were skipped.',
